...
# a = [-2, 3, 8, -11, -4, 6]
#
# number_count = len([num for num in a if num < 0])
#
# print(number_count)

# file = "text2.txt"
# f = open(file, "w")
# f.write("заменить в тексте файле; \n"
#         "Эизменить строкув списке;\n)"
#         "заменить  список в файл;\n")
# f.close()
# f = open(file)
# data = f.readline()
# print(data)
...
# f = open("text2.txt", "a+")
# print(f.write("i am learng python"))
# print(f.seek(3))
...
#     используемая как базовый объект взаимодействия с данными в операционных системах")
#
#
# def langest_world(file):
